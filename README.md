...
- <b>A Day in the life of Cybersecurity Generalist</b>
  - [Data Analysis using Splunk](https://github.com/Cyberlieutenant/LABURL)
Endpoint Compliance and Device Hardening
Policies for secure onboarding using Intune, Azure AD groups, and Autopilot profiles
Secure Identity Access
Conditional Access rules and MFA controls to protect user sessions
Cybersecurity Generalist Lab
<a href="https://github.com/Cyberlieutenant/LABURL">Data Analysis using Splunk</a>
